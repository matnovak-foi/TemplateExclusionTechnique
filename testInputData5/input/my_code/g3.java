...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        resources.add(org.foi.nwtis.matnovak.rest.serveri.MeteoRESTResourceContainer.class);
    }
...
public class DodajAdresu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            //TODO dovšriti izradu logike za obradom zahtjeva
...
public class PreuzmiMeteoPodatke extends Thread{
    ...
    @Override
    public void run() {
        //TODO napraviti logiku dohvaća meteo podataka za adrese iz baze
...
public class GeoMeteoWS {
    ...
    public java.util.List<Adresa> dajSveAdrese() {
        System.out.println("Pozvana metoda: org.foi.nwtis.matnovak.ws.serveri.GeoMeteoWS.dajSveAdrese()");
    ...
    public java.util.List<MeteoPodaci> dajSveMeteoPodatkeZaAdresu() {
        //TODO write your implementation code here:
        return null;
    }
}
